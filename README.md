...
The use of virtual scrolling removes the need for paging even on a huge list (tested with ~15k torrents and growing... I'm too lazy to clean up the queue), also on a mobile device.
...
You can donate with paypal in [eur](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=84LH348H27CN6) or [usd](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=7Z88PRASGESGQ), or using bitcoins @ 39iyJpmhkc3ZC66CNMERcu9N4HA1fdMxtB .
